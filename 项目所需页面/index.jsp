        ...
        <div class="col-md-12">
            ...
            <c:forEach items="${hotProductList}" var="hotProduct">
                <div class="col-md-2" style="text-align:center;height:210px;padding:10px 0px;">
                    ...
                    <p style="height:26px;"><a href="ProductInfoServlet?pid=${hotProduct.pid}"
                                               style='color:#666'>${hotProduct.pname}</a></p>
        ...
        <div class="col-md-12">
            ...
            <c:forEach items="${newProductList}" var="newProduct">
                <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                    ...
                    <p style="height:26px;"><a href="ProductInfoServlet?pid=${newProduct.pid}"
                                               style='color:#666'>${newProduct.pname}</a></p>
