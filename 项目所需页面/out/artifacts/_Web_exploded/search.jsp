    ...
    <ul class="pagination" style="text-align: center; margin-top: 10px;">
        ...
        <c:forEach begin="1" end="${totalPage}" var="pageNum">
            <c:if test="${currentPage==pageNum}">
                <li class="active"><a
                        href="SearchProductServlet?currentPage=${pageNum}&search=${search}">${pageNum }</a></li>
            </c:if>
            <c:if test="${currentPage!=pageNum }">
        ...
        <c:if test="${currentPage!=totalPage}">
            <li><a href="SearchProductServlet?currentPage=${currentPage+1}&search=${search}" aria-label="Next"> <span
