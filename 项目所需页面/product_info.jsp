...
<div class="container">
    <div class="row">
        ...
        <div style="margin: 0 auto; width: 950px;">
            ...
            <div class="col-md-6">
                ...
                <div style="margin: 10px 0 10px 0;">
                    亿家价: <strong style="color: #ef0101;">￥：${requestScope.product.shop_price}</strong> 参 考 价：
                    <del>￥${requestScope.product.market_price }</del>
                </div>
                ...
                <div
                    ...
                    <form action="AddCartServlet" method="get">
                        ...
                        <div style="margin: 20px 0 10px 0;; text-align: center;">
                            <input style="background: url('./images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0); height: 36px; width: 127px;" value="加入购物车" type="submit">&nbsp;收藏商品
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div style="width: 950px; margin: 0 auto;">
            ...
            <div>
                <textarea rows="10" cols="50">${requestScope.product.pdesc}</textarea>
            </div>
